; $Id: bar_plot.pro,v 1.10 2002/02/06 21:45:40 scottm Exp $
;
; Copyright (c) 1990-2002, Research Systems, Inc.  All rights reserved.
;	Unauthorized reproduction prohibited.
;
;Modified by Ankur Desai to include nolabel keyword 2002

pro my_bar_plot,values,baselines=baselines,colors=colors,barnames=barnames, $
          ...
          rotate=rotate,nolabel=nolabel,range=range
;+
; NAME:
;	BAR_PLOT
;
...
IF n_elements(range) EQ 0 THEN range=[mnB < mnV, $    ;Minimum of bases & values
